...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [5627372.952700, 3016978.483415, 5629379.088492, 3018303.290070], maxZoom: 28, minZoom: 1
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([5627372.952700, 3016978.483415, 5629379.088492, 3018303.290070], map.getSize());
...
var searchLayer = new SearchLayer({
    layer: lyr_Parcel_numberRIFFA_ALBUHAIR_2,
    colName: 'BSI_str',
    zoom: 10,
    collapsed: true,
    map: map
